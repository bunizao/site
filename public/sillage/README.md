...
| `sky.webp`    | Dusk sets only: the sky's colour, one wash eased out to the bare page before the footer's text, crayon only along the horizon. Tiles across; lossless alpha, because a lossy one bands. |
