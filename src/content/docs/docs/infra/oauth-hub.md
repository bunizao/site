...
- `/dev/login` starts the human login flow.
...
- `/oauth` redirects to the protected hub.
...
- Keep one human authority — the allow-listed GitHub account in `ADMIN_GITHUB_LOGIN`.
