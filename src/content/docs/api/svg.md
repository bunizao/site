...
stale-while-revalidate=3600`, keeping the existing TTL while allowing background
refresh. The private Worker's platform cache remains a separate rollout gate.
