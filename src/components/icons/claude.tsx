// Claude product mark (the sunburst, Simple Icons), monochrome via currentColor.
// Distinct from AnthropicIcon (the company "A"): this is the product, used on
// the palette's "Ask Claude" row.
