...
export const mockTags: TagData[] = [
  ...
  {
    id: 'tag-en-quiet-architecture',
    slug: 'hash-en-quiet-architecture',
    name: '#en:quiet-architecture',
    url: '/tag/hash-en-quiet-architecture/',
    description: null,
    featureImage: null,
    accentColor: null,
    visibility: 'internal',
  ...
  {
    id: 'tag-public-unlisted',
    slug: 'unlisted',
    name: 'Unlisted',
    url: '/tag/unlisted/',
    description: 'A public tag whose similar name must not hide a post.',
    featureImage: null,
    accentColor: null,
    visibility: 'public',
    codeInjectionHead: null,
...
export const mockPosts: PostRecord[] = [
  createPost({
    id: 'post-unlisted',
    slug: 'private-link-demo',
    title: 'Direct link only fixture',
    url: '/private-link-demo/',
    html: '<p>This public post is intentionally absent from every discovery surface.</p>',
    excerpt: 'A deterministic unlisted post fixture.',
    customExcerpt: null,
    featureImage: null,
    featureImageAlt: null,
    featureImageCaption: null,
    publishedAt: '2026-05-31T10:30:00.000Z',
    updatedAt: '2026-05-31T10:30:00.000Z',
    featured: false,
    primaryAuthorSlug: 'iris-zhang',
    primaryTagSlug: 'systems',
    authorSlugs: ['iris-zhang'],
    tagSlugs: ['systems', 'hash-unlisted'],
  }),
  createPost({
  ...
  createPost({
    id: 'post-quiet-architecture-en',
    slug: 'on-quiet-architecture',
    title: 'On quiet architecture',
    url: '/on-quiet-architecture/',
    html: '<p>Small seams, explicit data, and no ceremonial indirection. That is the whole pitch.</p>',
    excerpt: 'The best structure is the one future-you can debug half asleep.',
    customExcerpt: null,
    featureImage: '/mock/tag-systems.svg',
    ...
    primaryTagSlug: 'systems',
    authorSlugs: ['sam-lin'],
    tagSlugs: ['systems', 'hash-en-quiet-architecture'],
    commentsEnabled: false,
    commentsHtml: null,
  }),
  createPost({
