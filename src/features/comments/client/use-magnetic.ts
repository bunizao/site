/* Magnetic pointer pull.
   ...
   The target is the flip wrapper, not the faces it holds. The faces already own
   a transform — the sign-in rotateY — and an inline write here would clobber it,
   un-flipping a signed-out card the moment the cursor came near. Pulling the
   parent lets the two compose: the card drifts, the faces turn inside it. */
