...
// 'owner_message_create' is the /message form. It shares this module rather
// than growing its own because the widget lifecycle -- warm early, read at
// submit, re-mint on expiry -- is identical; only the action string differs.
export type TurnstileAction = 'blog_comment_create' | 'blog_reaction' | 'owner_message_create';
