...
export const GET: APIRoute = async ({ request, locals }) => {
  ...
  const svg = `
    <svg width="400" height="160" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Project Name -->
      <text x="20" y="35" font-family="Geist, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" font-size="16" font-weight="600" fill="${colors.text}">
      ...
      ${stars !== null ? `
        <g transform="translate(350, 25)">
          ...
          <text x="16" y="10" font-family="Geist Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="11" font-weight="500" fill="${colors.muted}">
            ${stars}
          </text>
        </g>
      ` : ''}
      ...
      <!-- Description -->
      <text x="20" y="60" font-family="Geist, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" font-size="12" fill="${colors.muted}">
        ${escapeXml(project.description.substring(0, 50))}
      </text>
      ${project.description.length > 50 ? `
        <text x="20" y="78" font-family="Geist, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" font-size="12" fill="${colors.muted}">
      ...
      <g transform="translate(20, 100)">
        ...
        <text x="30" y="14" font-family="Geist, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" font-size="9" font-weight="600" fill="${colors.muted}" text-anchor="middle">
      ...
      ${project.tags.slice(0, 3).map((tag, i) => `
        <text x="${90 + i * 80}" y="114" font-family="Geist Mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace" font-size="10" fill="${colors.muted}">
